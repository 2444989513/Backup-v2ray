...
archive="${repo}/bazel-out/k8-fastbuild/bin/release/v2ray-linux-ppc64.zip"
...
ln -sf "${repo}/release/config/systemd/system/v2ray@.service" "${tmp}/systemd/system/v2ray@.service"
ln -sf "${repo}/bazel-out/k8-fastbuild/bin/infra/control/main/linux/ppc64/0/v2ctl" "${tmp}/v2ctl"
ln -sf "${repo}/bazel-out/k8-fastbuild/bin/infra/control/main/linux/ppc64/0/v2ctl.sig" "${tmp}/v2ctl.sig"
ln -sf "${repo}/bazel-out/k8-fastbuild/bin/main/linux/ppc64/0/v2ray" "${tmp}/v2ray"
ln -sf "${repo}/bazel-out/k8-fastbuild/bin/main/linux/ppc64/0/v2ray.sig" "${tmp}/v2ray.sig"
